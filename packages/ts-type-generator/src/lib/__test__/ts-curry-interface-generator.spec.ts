import { of } from 'rxjs';
import { generateCurryInterfaceInDocument } from '@solidgrounds/ts-type-generator';

it('generateCurryInterfaceInDocument', async () => {
  expect(
    await of(`
  /**
   ...
   */
`)
      .pipe(generateCurryInterfaceInDocument)
      .toPromise()
