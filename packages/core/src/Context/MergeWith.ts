...
export interface MergeWith<T> {
  ...
  create<K1 extends keyof T, K2 extends keyof T>(
    t1: K1,
    t2: K2,
    options?: MergeOptions
  ): SAF<Pick<T, K1 | K2>>;

  create<K1 extends keyof T, K2 extends keyof T, K3 extends keyof T>(
    t1: K1,
    t2: K2,
    t3: K3,
    options?: MergeOptions
  ...
  >(
    ...
    t7: K7,
    options?: MergeOptions
  ): SAF<Pick<T, K1 | K2 | K3 | K4 | K5 | K6 | K7>>;
  ...
  >(
    ...
    t8: K8,
    options?: MergeOptions
  ): SAF<Pick<T, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8>>;
  ...
  >(
    ...
    t9: K9,
    options?: MergeOptions
  ): SAF<Pick<T, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8 | K9>>;
  ...
  >(
    ...
    t10: K10,
    options?: MergeOptions
  ): SAF<Pick<T, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8 | K9 | K10>>;
}
