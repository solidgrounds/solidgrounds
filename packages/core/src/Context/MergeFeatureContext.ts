...
export interface MergeFeatureContext<Services> {
  ...
  merge<K1 extends keyof Services, K2 extends keyof Services>(
    k1: K1,
    k2: K2
  ): MergeWith<Pick<Services, K1 | K2>>;

  merge<
    K1 extends keyof Services,
    K2 extends keyof Services,
    K3 extends keyof Services
  >(
    k1: K1,
    k2: K2,
    k3: K3
  ): MergeWith<Pick<Services, K1 | K2 | K3>>;

  merge<
    K1 extends keyof Services,
    K2 extends keyof Services,
    K3 extends keyof Services,
    K4 extends keyof Services
  >(
    k1: K1,
    k2: K2,
    k3: K3,
    k4: K4
  ): MergeWith<Pick<Services, K1 | K2 | K3 | K4>>;
  ...
  >(
    ...
    k4: K4,
    k5: K5
  ): MergeWith<Pick<Services, K1 | K2 | K3 | K4 | K5>>;
  ...
  >(
    ...
    k5: K5,
    k6: K6
  ): MergeWith<Pick<Services, K1 | K2 | K3 | K4 | K5 | K6>>;
  ...
  >(
    ...
    k6: K6,
    k7: K7
  ): MergeWith<Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7>>;
  ...
  >(
    ...
    k7: K7,
    k8: K8
  ): MergeWith<Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8>>;
  ...
  >(
    ...
    k8: K8,
    k9: K9
  ): MergeWith<Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8 | K9>>;
  ...
  >(
    ...
    Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8 | K9 | K10>
  >;
}

export const createFeatureMergeContext = <T>(
...
const createMergeWith = <T>(
  context: CompileContext<unknown>,
  features: UFF[]
): MergeWith<T> => {
  const create = (...args: unknown[]): ServicesAsFactories<unknown> => {
    const keys = args as (keyof T)[];
  ...
  return {
    with<ExtendWith>(
      featureFactory: FeatureFactory<ExtendWith, T>
    ): MergeWith<T & ExtendWith> {
      return createMergeWith<T & ExtendWith>(context, [
        ...features,
        featureFactory as UFF,
      ]);
    },
